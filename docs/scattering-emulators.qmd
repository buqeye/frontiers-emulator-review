...
```{python}
#| label: fig-phase-shifts-yamaguchi
#| fig-cap: "Phase shifts constructed via various scattering emulators"
...
```{python}
#| label: fig-wave-functions-yamaguchi
#| fig-cap: "Wave functions constructed via the KVP."
...
ax.plot(q_cm, delta_1S0_nvp, **PRED_KWARGS, label="Emulator")
ax.plot(q_cm, delta_1S0_kvp, **PRED_KWARGS, label="Emulator")
...
#| fig-cap: "Wave functions constructed via the origin emulator."
bc_idx = 0
