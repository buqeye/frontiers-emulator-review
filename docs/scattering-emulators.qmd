...
$$
\left[\braket{\psi_i | V - V G_0 V | \psi_j} + \braket{\psi_j | V - V G_0 V | \psi_i} \right]\coeff_j = \braket{\psi_i | V | \phi} + \braket{\phi | V | \psi_i}
$$ {#eq-schwinger-linear}
for all $i = 1, \dots, \nbasis$.
...
This yields
$$
\braket{\psi_i | V - V G_0 V | \psi_j} \coeff_j = \braket{\psi_i | V | \phi}.
$$
