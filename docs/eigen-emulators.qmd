...
#| fig-cap: "Absolute residuals of the emulated wave functions (in fm$^{-1/2}$) based on the RBM and HO emulator as a function of the radius. The emulator results are compared to the exact solutions. See the main text for details."
#| echo: false
