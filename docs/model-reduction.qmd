...
![Illustration of offline-online compositions for fast & accurate emulators. Inspired by Figure~1 in Ref.[]](offline_online.png){fig.pos='tb'}

![Illustration of an RBM. Inspired by Figure~1 in Ref.[]](rbm.png){fig.pos='tb'}
